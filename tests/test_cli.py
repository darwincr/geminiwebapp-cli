...
from geminiwebapp_cli.actions.chats import _research_payload, _response_payload, _select_video_aspect_ratio_if_needed, _tool_label, _trim_research_report_text, _video_aspect_ratio_label, chat_id_from_url, chat_url
...
class TestCliParsing:
    ...
    def test_research_payload_includes_agent_metadata(self):
        ...
        assert payload["next_command"] == "geminiwebapp-cli chats research https://gemini.google.com/app/abc --wait --timeout 1800 --poll-interval 30 --json"
        assert payload["wait_command"] == "geminiwebapp-cli chats research https://gemini.google.com/app/abc --wait --timeout 1800 --poll-interval 30 --json"
